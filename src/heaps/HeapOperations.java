...
//   }
//
//   public void minHeapify(int []heap,int i){ //same as ShiftUp function - i.e Heapifying by shifting down.
//       int parent=i/2;//its always going to be true
//       if(isValidParent(parent)){ //if i>=0 for 0 based indexing and 1 for 1 based indexing
